...
use ScavixWDF\Model\WdfPdoStatement;
...
class MySql implements IDatabaseDriver
{
    ...
    private function pdoQuery($sql): WdfPdoStatement
    {
        /** @var WdfPdoStatement $res */
	...
	function initDriver($datasource,$pdo)
	{
        ...
        $mode = $this->pdoQuery("SELECT @@SESSION.sql_mode; SET CHARACTER SET $charset; SET NAMES $charset;")
            ->finishScalar();
