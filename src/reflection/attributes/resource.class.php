...
/**
 * Allows to require resources for classes.
 *
 * Sample usage:
 * <code php>
 * #[Resource('res/static/somefile.js');
 * #[Resource('res/static/someother.less');
...
{
    function __construct(string $resource)
    {
        // log_debug(__METHOD__,$resource);
